                            ...
                            <div className="flex">
                                ...
                                <div className="flex flex-col items-start">
                                    ...
                                    <div className="flex gap-4 mt-8">
                                        <a href={currentProject.githubUrl} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 px-4 py-2 bg-white text-black rounded-full text-md md:text-lg font-medium transition-all duration-300 hover:bg-white/90 hover:scale-105"><ExternalLink className="w-4 h-4" />View Project</a>
                                        <a href={currentProject.githubUrl} target="_blank" rel="noopener noreferrer" className="group flex items-center gap-2 px-4 py-2 border border-white/20 text-white rounded-full text-md md:text-lg font-medium transition-all duration-300 hover:bg-white/10"><Github className="w-4 h-4" />Source</a>
                                    </div>
                                </div>
                            </div>
                        )}
