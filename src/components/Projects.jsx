...
function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      longDescription: "An AI-powered tool detecting whether text was human-written or AI-generated. Built on a GPT-2 + DeBERTa ensemble with 85%+ classification accuracy, plus a semantic plagiarism engine using SentenceTransformers that cut similarity search latency by 40%.",
      tech: ["React.js", "FastAPI", "Python", "HuggingFace", "DeBERTa", "SentenceTransformers"],
      status: "Live",
      githubStars: "21 stars",
      lastUpdated: "2025",
      image: "https://images.unsplash.com/photo-1620712943543-bcc4688e7485?w=1200&q=80",
      githubUrl: "https://github.com/Ankith-sara/authentiq",
      gradient: "linear-gradient(160deg, rgb(10,45,80) 0%, rgb(20,100,180) 60%, rgb(80,160,240) 85%, rgb(200,230,255) 100%)",
      textColor: "#a8d0f8",
      shadowColor: "#1464B4",
      features: ["85%+ accuracy via GPT-2 + DeBERTa ensemble.", "Semantic plagiarism engine with SentenceTransformers.", "40% reduction in similarity search latency.", "FastAPI backend with async inference.", "Clean React frontend for instant results."]
    },
    {
      id: 4,
      title: "Book Store",
